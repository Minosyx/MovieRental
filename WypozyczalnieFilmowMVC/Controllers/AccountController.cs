    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    string callbackUrl =
                        await SendEmailConfirmationTokenAsync(user.Id, "Confirm your e-mail.");

                    ViewBag.errorMessage = "You must confirm your e-mail before signing in.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Confirm your e-mail.");

                    ViewBag.Message =
                        "Check your mailbox and confirm e-mail. You must confirm your e-mail before signing in.";
        ...
        private async Task<string> SendEmailConfirmationTokenAsync(string userID, string subject)
        {
            ...
            await UserManager.SendEmailAsync(userID, subject,
                "Please confirm your e-mail by clicking <a href=\"" + callbackUrl + "\">here</a>");
            return callbackUrl;
        }
        #endregion
    }
